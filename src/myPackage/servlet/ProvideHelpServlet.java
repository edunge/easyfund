...
/**
 * Servlet implementation class ProvideHelpServlet
 */
@WebServlet(urlPatterns={"/provideHelp"})
public class ProvideHelpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProvideHelpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher 	=	getServletContext().getRequestDispatcher("/WEB-INF/views/provideHelpView.jsp");
